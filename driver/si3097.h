...
#define SI_IOCTL_GET_SERIAL                                                    \
	_IOR(SI_MAGIC, MSG_SI_GET_SERIAL, struct SI_SERIAL_PARAM)
#define SI_IOCTL_SET_SERIAL                                                    \
	_IOW(SI_MAGIC, MSG_SI_SET_SERIAL, struct SI_SERIAL_PARAM)
...
#define SI_IOCTL_DMA_START                                                     \
	_IOR(SI_MAGIC, MSG_SI_DMA_START, struct SI_DMA_STATUS)

#define SI_IOCTL_DMA_STATUS                                                    \
	_IOWR(SI_MAGIC, MSG_SI_DMA_STATUS, struct SI_DMA_STATUS)
#define SI_IOCTL_DMA_ABORT                                                     \
	_IOWR(SI_MAGIC, MSG_SI_DMA_ABORT, struct SI_DMA_STATUS)
